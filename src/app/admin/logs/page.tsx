...
export default function AuditLogsPage() {
    ...
    const fetchLogs = async () => {
        setLoading(true);
        try {
            const res = await fetch(`/api/admin/logs?timeframe=${timeframe}`);
            if (res.ok) {
        ...
        <div className="max-w-7xl mx-auto space-y-8 pb-20">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-slate-400 font-medium">Complete historical view of all storefront and administrative activities (Real-time tracking).</p>
                </div>
            </div>
